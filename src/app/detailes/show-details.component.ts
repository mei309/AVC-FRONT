...
<ng-container *ngIf="dataSource; else noData">
    <button *ngIf="getUserManagment(dataSource.processName)" class="no-print" mat-raised-button color="accent" (click)="openManagment(dataSource.processName)">Managment</button>
