...
import { addDays, addMonths, addYears, format, getDate, getDay, getDaysInMonth, getMonth, getYear, parse, parseISO, parseJSON, setDay, setMonth, toDate} from "date-fns";
...
export interface NgxDateFnsDateAdapterOptionsMine {
    useUtc?: boolean;
  }
  
  export const NGX_MAT_DATEFNS_DATE_ADAPTER_OPTIONS_MINE =
    new InjectionToken<NgxDateFnsDateAdapterOptionsMine>(
      'NGX_MAT_DATEFNS_DATE_ADAPTER_OPTIONS_MINE',
      {
        providedIn: 'root',
        factory: NGX_MAT_DATEFNS_DATE_ADAPTER_OPTIONS_MINE_FACTORY,
      }
    );
  
  export function NGX_MAT_DATEFNS_DATE_ADAPTER_OPTIONS_MINE_FACTORY(): NgxDateFnsDateAdapterOptionsMine {
    return {
      useUtc: false,
    };
  }
...
export class NgxDateFnsDateAdapterMine extends NgxMatDateAdapter<Date> {
  ...
  constructor(
    ...
    @Optional()
    @Inject(NGX_MAT_DATEFNS_DATE_ADAPTER_OPTIONS_MINE)
    private options?: NgxDateFnsDateAdapterOptionsMine
  ) {
    super();
